#
#  Be sure to run `pod spec lint AlmappCore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/almapp/AlmappCore-ios", :tag => "0.0.2" }
